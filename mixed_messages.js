...
console.log(`Your hometown is in ${city[generateRandomNumber(city.length)]}.`);
console.log(`Your favorite pokemon is ${pokemon[generateRandomNumber(pokemon.length)]}.`);
console.log(`You will take ${attempts[generateRandomNumber(attempts.length)]} attempts before you finally beat the Elite Four!`);
